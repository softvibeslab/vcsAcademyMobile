    ...
    with connect() as db:
        ...
        default_resources = [
            (
                ...
                "practice_script",
                0,
                "Practice a clear, respectful commitment check: if the program makes sense and is affordable, can the guest make a yes/no decision today?",
            ...
            (
                ...
                "general_training",
                0,
                "Create a professional first impression, learn names, set warmth, and begin trust before the agenda.",
                ["blueprint", "step-1", "rapport"],
            ),
            (
                ...
                "general_training",
                0,
                "Set expectations early: explain the visit flow, confirm time, and create a clear path for the presentation.",
                ["blueprint", "step-2", "agenda"],
            ),
            (
                "form-discovery-cards",
                "F.O.R.M. Discovery Cards",
                "worksheet",
                "general_training",
                0,
                "Use family, occupation, recreation, and motivation questions to uncover travel goals without interrogating the guest.",
                ["blueprint", "step-3", "discovery"],
            ),
            (
                ...
                "general_training",
                0,
                "Tie amenities and property moments back to the guest's stated travel motivations and ownership fit.",
                ["blueprint", "step-6", "tour"],
            ),
            (
                ...
                "general_training",
                0,
                "Help the guest imagine future vacations by connecting the suite to family use, comfort, and ownership value.",
                ["blueprint", "step-7", "storytelling"],
            ),
            (
                "point-confirmation-coach",
                "Point of Confirmation Coach",
                "checklist",
                "general_training",
                0,
                "Confirm value, fit, and readiness before program presentation. Surface objections clearly and professionally.",
                ["blueprint", "step-9", "confirmation"],
            ),
            (
                "pricing-guide",
                "T.O. Pricing Guide",
            ...
            (
                ...
                "pricing_or_fee_related",
                1,
                "Fees and conditions must be disclosed with approved language and source documents. Never hide fees or imply unavailable discounts.",
                ["compliance", "fees", "pricing", "sensitive"],
            ),
        ]
